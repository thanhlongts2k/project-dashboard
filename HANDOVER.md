...
**Phiên bản:** `v1.0.6` (Deep Linking & URL State Sync)  
...
- **Kết Nối REST API Backend Thực Tế:**
  ...
  * `GET /api/debt/bus/<bu_code>/drilldown/?period=YYYY-MM&employee=<employee_code>`
...
| 8 | [`src/pages/DebtAgingReportPage.jsx`](file:///d:/Sources/project-dashboard/src/pages/DebtAgingReportPage.jsx) | **198 dòng** | ✅ Đạt (< 200) | Page Controller điều phối lifecycle, RBAC & Deep Linking |
...
- **Commit:** `feat(aging): implement deep linking and URL state sync for BU and employee drilldown`
